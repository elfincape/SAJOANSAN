...
assert.match(source,/record\?\.a==null\?'A 온도'/,'missing A temperature should trigger fallback');
assert.match(source,/record\?\.b==null\?'B 온도'/,'missing B temperature should trigger fallback');
