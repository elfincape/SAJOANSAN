...
assert.match(source,/Number\(parts\.hour\)>=20\?1:0/,'Korean Standard Time 20:00 through 23:59 should select the next date');
...
assert.equal(defaultKoreanDate(new Date('2026-08-19T10:59:00Z')),'2026-08-19','Korean Standard Time 19:59 should use the current Korean date');
assert.equal(defaultKoreanDate(new Date('2026-08-19T11:00:00Z')),'2026-08-20','Korean Standard Time 20:00 should use the next Korean date');
